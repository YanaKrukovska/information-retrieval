...
public class PermutermIndexBuilder {
    ...
    public static PermutermIndex createCollection(List<String> files) {

        PermutermIndex permutermIndex = new PermutermIndex(files);
        ...
        for (String fileName : files) {
            try {
                ...
                for (String word : wordList) {
                    permutermIndex.generateRotations(word.toLowerCase());
                }
